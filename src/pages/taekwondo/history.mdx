...
<div class="md:container mx-auto prose-img:inline prose-img:m-0">
    <table>
        ...
        <tbody>
            <tr>
                <td>
                    <RelImage src="/poomse/il-jang.gif" alt="Kien" />
                </td>
            ...
            <tr>
                <td>
                    <RelImage src="/poomse/sam-jang.gif" alt="Li" />
                </td>
            ...
            <tr>
                <td>
                    <RelImage src="/poomse/yuk-jang.gif" alt="Kan" />
                </td>
            ...
            <tr>
                <td>
                    <RelImage src="/poomse/pal-jang.gif" alt="Kun" />
                </td>
